...
headerRows: 2,
body: [
    [{text:`Persona Fisica (PF):  `,fontSize:9,colSpan: 2, border:[false,false,false,false],alignment:'right'},{},{text:(this.aval.tipo_persona=='Fisica')?'X':'', alignment:'center',fontSize:10}],
    [{text:`Persona Fisica con Actividad Empresarial (PFAE):  `,fontSize:9,colSpan: 2, border:[false,false,false,false],alignment:'right'},{},{text:'  '}],
    [{text:`Persona Moral (PM):  `,fontSize:9,colSpan: 2, border:[false,false,false,false],alignment:'right'},{},{text:(this.aval.tipo_persona=='Moral')?'X':'', alignment:'center',fontSize:10}]
]
}
},
{
...
widths: [60,60,55,55,55,55,50,60],
body: [
    [{text:`Nombre del Solicitante:`,style:'gene',colSpan:2,border:[false,false,false,false]},{},{text:`${this.aval.nombre} ${this.aval.apellido_paterno} ${this.aval.apellido_materno}`,colSpan:6,border:[false,false,false,true],fontSize:10},{},{},{},{},{}],
    [{text:`Fecha de constitución o nacimiento`,style:'gene',colSpan:3,border:[false,false,false,false]},{},{},{text:`(dd/mmm/aaaa);`, colSpan:2, fontSize:9,margin:[0,2,0,0],border:[false,false,false,false]},{},{text:this.aval.fecha_nacimiento,colSpan:3,border:[false,false,false,true],fontSize:10},{},{}],
    [{text:`R.F.C.:`,style:'gene',border:[false,false,false,false]},{text:this.aval.rfc.toUpperCase(),colSpan:3,border:[false,false,false,true],fontSize:10},{},{},{text:'CURP:',style:'gene',border:[false,false,false,false]},{text:this.aval.curp.toUpperCase(),colSpan:3,border:[false,false,false,true],fontSize:10},{},{}],
    [{text:`Domicilio`,style:'gene',border:[false,false,false,false]},{text:this.aval.domicilio_direccion,colSpan:7,border:[false,false,false,true],fontSize:10},{},{},{},{},{},{}],
    [{text:`Colonia`,style:'gene',border:[false,false,false,false]},{text:this.aval.domicilio_colonia,colSpan:7,border:[false,false,false,true],fontSize:10},{},{},{},{},{},{}],
...
widths: [60,60,55,55,55,55,50,60],
body: [
    [{text:'',colSpan:2,border:[false,false,false,false]},{},{text:`${this.aval.nombre} ${this.aval.apellido_paterno} ${this.aval.apellido_materno}`,fontSize:10,colSpan:4,border:[false,false,false,true],alignment:'center'},{},{},{},{text:'',colSpan:2,border:[false,false,false,false]},{}],
    [{text:'',colSpan:3,border:[false,false,false,false]},{},{},{text:'Nombre y Firma',style:'gene', alignment:'center', colSpan:2,border:[false,false,false,false]},{},{text:'',colSpan:3,border:[false,false,false,false]},{},{}]
]
}
},
