  ...
  async imprimir() {
    ...
    for (let uno of this.tabla) {
      ...
      if (conta == this.tabla.length) {
        solo.push({ text: uno.num_pago + '', border: [true, false, true, true], fontSize: 10, });
        solo.push({ text: uno.fecha_inicial, border: [true, false, true, true], fontSize: 10, });
        solo.push({ text: uno.fecha_fin, border: [true, false, true, true], fontSize: 10, });
        solo.push({ text: uno.plazo_dias + '', border: [true, false, true, true], fontSize: 10, });
        solo.push({ text: this.formatdinero.format(uno.saldo_inicial), border: [true, false, true, true], fontSize: 10, });
        solo.push({ text: this.formatdinero.format(uno.pago_interes), border: [true, false, true, true], fontSize: 10, });
        solo.push({ text: this.formatdinero.format(uno.pago_capital), border: [true, false, true, true], fontSize: 10, });
        solo.push({ text: this.formatdinero.format(uno.monto_pago), border: [true, false, true, true], fontSize: 10, });
        pdfin.push(solo);
      } else {
        solo.push({ text: uno.num_pago + '', border: [true, false, true, false], fontSize: 10, });
        solo.push({ text: uno.fecha_inicial, border: [true, false, true, false], fontSize: 10, });
        solo.push({ text: uno.fecha_fin, border: [true, false, true, false], fontSize: 10, });
        solo.push({ text: uno.plazo_dias + '', border: [true, false, true, false], fontSize: 10, });
        solo.push({ text: this.formatdinero.format(uno.saldo_inicial), border: [true, false, true, false], fontSize: 10, });
        solo.push({ text: this.formatdinero.format(uno.pago_interes), border: [true, false, true, false], fontSize: 10, });
        solo.push({ text: this.formatdinero.format(uno.pago_capital), border: [true, false, true, false], fontSize: 10, });
        solo.push({ text: this.formatdinero.format(uno.monto_pago), border: [true, false, true, false], fontSize: 10, });
        pdfin.push(solo);
      }
    }
      ...
      content: [
        ...
        },
        {
          ...
          table: {
            ...
            headerRows: 1,
            body: [
              [{ image: this.local.logo_files, width: 100, alignment: 'center', rowSpan: 9, margin: [0, 40, 0, 0] }, { text: 'Resumen del Préstamo', colSpan: 3, style: 'encabezado' }, {}, {}, { image: this.local.empresa.empresa_logo_base64, width: 100, alignment: 'center', rowSpan: 9, margin: [0, 20, 0, 0] }],
        ...
        },
        {
          style: 'tableExample',
          table: {
            widths: [30, 75, 75, 30, 75, 75, 75, 75],
            headerRows: 1,
            body: pdfin
          }
        },
